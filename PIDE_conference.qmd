...
# 36th AGM and Conference of PSDE <br> [Charter of Economy]{.hi-orange} <br> Investment, Productivity & Employment {background-color="#264653"}
...
### How well equipped university graduates are  with skills of jobs of today and tomorrow?
...
> ### ["People will need to embrace digital and intelligent technologies if they're going to be successful in their jobs," Tom shared. "I worked with a radiologist in the Boston area who also has a Ph.D. in AI. And he kept saying, 'The only radiologists who are gonna lose their jobs to AI are those who refuse to work with AI.'"]{.hi-orange} [Working with AI: Real Stories of Human-Machine Collaboration](https://www.amazon.com/Working-AI-Human-Machine-Collaboration-Management-ebook/dp/B09P9GRQ17/ref=sr_1_1?crid=2U04PYZ0GCG2L&keywords=Working+with+AI%3A+Real+Stories+of+Human-Machine+Collaboration&qid=1663687252&sprefix=working+with+ai+real+stories+of+human-machine+collaboration%2Caps%2C103&sr=8-1)
...
-   Easy access to education can function as an equalizing factor, although it is pretty clear that it does not perform this function very well

-   Finally, the system of education and training maintains a common culture and a common understanding of citizenship. The point I was making just now was only that more training or even better training does not necessarily lead to higher employment.
:::
...
> #### [Create opportunities for working learners for re-skilling and up-skilling opportunities.]{.hi-orange}
...
> #### [We argue that the US must invest in existing educational and training institutions and innovate to create new training models to make ongoing skills development accessible, engaging, and cost effective.]{.hi-orange} 



# I argue the need for developing [a new learning ecosystem]{.hi-orange} to make ongoing skill development [accessible, engaging, and cost effective]{.red}. {background-color="#264653"}
